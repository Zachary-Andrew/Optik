...
// 2‑bit encoding: A=00, C=01, G=10, T=11. Invalid → 0xFF.
...
// Complement: A↔T (0↔3), C↔G (1↔2). XOR with 3 works.
...
// Encode exactly k characters from seq into out. Returns false if any N.
...
// Roll: shift left, add new base, mask to 2k bits.
