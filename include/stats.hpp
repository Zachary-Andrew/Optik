...
// Bessel correction: divide by n-1 for unbiased sample variance
...
// Half-width of 95% confidence interval: t * (s / sqrt(n))
...
static double ibeta(double x, double a, double b) {
    ...
    // Use complement symmetry for better convergence when x is large
    bool swapped = false;
